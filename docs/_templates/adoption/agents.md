...
- Use `docs/bin/new-doc.sh` for reusable document drafts. Issue numbered project/task/QA documents only from a clean, current `main`; the script commits those drafts on `main`.
